...
const Skills = ({ darkMode }: { darkMode: boolean }) => {
  const skills = [
    ...
    },
    {
      ...
      icon: framer_motion,
      level: 90,
      color: "form-blue-500 to-cyan-500",
    },
    {
      name: "vue",
      icon: vue,
      level: 88,
      color: "form-yellow-500 to-amber-500",
    },
    {
      name: "React",
      icon: react,
          ...
          <div className="container px-5 py-14 mx-auto">
            <div className="text-center mb-20" data-aos="fade-up">
              ...
              >
                ...
                fast, responsive, and scalable web applications. My skill set
                includes React for dynamic user interfaces, Tailwind CSS for
                clean and responsive design, Framer Motion for smooth
                animations, Vue for component-based development, Laravel for
                backend logic, and Vite for fast and optimized development
                workflows.
              </p>
            </div>
            <div
              ...
              {skills.map((skill, index) => (
                ...
                >
                  <div
                    ...
                    className="h-full p-6 rounded-2xl border hover:border-orange-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgb(255,165,0,0.15)]"
                  >
                    ...
                    <div
                      className={`group mt-6 pt-4 border-t ${darkMode ? "border-gray-700" : "border-gray-300"}`}
                    >
                      <div
