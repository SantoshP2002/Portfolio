        ...
        <div className="container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-14 flex-col lg:flex-row items-center justify-between lg:mt-14 mt-14">
          <div className="lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0">
            ...
            >
              ...
              interactive web applications. I work with React and modern UI
              tools to create smooth user experiences with clean and
              maintainable code.
            </p>
            {/* Buttons  */}
            <div className="w-full pt-4 sm:pt-6">
              ...
              >
                ...
                <a href="#contact" className="w-full sm:w-auto">
                  <button
                    className={`w-full sm:w-auto inline-flex items-center ${theme.buttonSecondary} justify-center dark:text-white border-0 py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform`}
                  >
                    <Mail className="w-4 h-4 sm:w-5 sm:h-5 mr-2" /> Contact Me
                  </button>
                </a>
              </div>
            </div>
            ...
            <div className="relative w-4/5 sm:w-3/4 lg:w-full">
              <div className="relative overflow-hidden">
                ...
                <img
                  src={hi}
                  alt="Hi Icon"
                  className="absolute top-1 sm:top-5 left-10 sm:left-20 w-10 h-14 sm:w-20 sm:h-20 object-contain animate-bounce opacity-90 z-10"
                />
              </div>
            </div>
          </div>
