    ...
    <div className="flex justify-center w-full fixed z-50 mt-4">
      ...
      >
        <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
          ...
          >
            <span className={`test-xl font-bold ${colors.textPrimary}`}>
              ...
              >
                ...
                {activeSection === item.name.toLowerCase() && (
                  <motion.div
                    ...
                    className={`absolute -bottom-1 left-0 right-0 h-0.5 bg-liner-to-r rounded-full ${colors.indicator}`}
                  ></motion.div>
                )}
              </a>
            ))}
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`hidden lg:block px-6 py-2 font-semibold rounded-full bg-liner-to -r ${colors.button} text-white bg-amber-600 shadow-md hover:shadow-lg transition-shadow`}
            >
              Hire Me
            </motion.a>
          </div>
        ...
        {isMenuOpen && (
          <motion.button
            ...
            className={`absolute top-full left-0 right-0 mt-2 lg:hidden ${darkMode ? "bg-gray-900/95" : "bg-white/95"} backdrop-blur-lg rounded-xl shadow-lg border ${
