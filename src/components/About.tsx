      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          <div className="relative w-72 h-72 lg:w-96 lg:h-96 ">
            {/* Image  */}
            <div
              className="absolute -inset-6 lg:-inset-20 bg-linear-to-l from-[#f97316] via-[#fb923c] to-[#f59e0b] rotate-12 rounded-xl star-shape z-0"
              data-aos="zoom-in"
              data-aos-delay="600"
            >
              <img
        ...
        >
          ...
          >
            ...
            React and modern UI tools to create smooth experiences with
